...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'The Simplest Habit Tracker Online – Zero Friction, 100% Focus',
    description:
      'Tired of habit apps that feel like a second job? Try the simplest habit tracker online and experience zero friction habit building.',
    url: 'https://www.habittracker.life/simple-habit-tracker/',
  },
  alternates: {
    canonical: 'https://www.habittracker.life/simple-habit-tracker/',
  },
};
  ...
  return (
    ...
    >
      <main className={styles.container}>
        <header className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Tired of habit apps that feel like a second job? Welcome to the most minimal habit tracker ever built. No setup fatigue. No notification spam. Just pure habit building.
          </p>
          <Link href="/free-habit-tracker" className={styles.ctaButton}>
        ...
        <section>
          ...
          <p className={styles.p}>
            Every "feature-rich" habit app promises to help, but they often create more problems than they solve:
          </p>
          ...
          <p className={styles.p}>
            Research shows that every decision point decreases your likelihood of following through. When building habits, your brain needs <strong>fewer</strong> decisions, not more.
          </p>
        ...
        <section>
          ...
          <div className={styles.featureGrid}>
            <div className={styles.featureItem}>
              ...
              <p className={styles.p}>
                Just open and start tracking. Your data stays in your browser. No accounts to manage, no passwords to forget.
              </p>
            </div>
            ...
            <div className={styles.featureItem}>
              ...
              <p className={styles.p}>
                Type your habit name. Hit enter. Done. No categories, colors, icons, or complexity.
              </p>
            </div>
            ...
            <div className={styles.featureItem}>
              ...
              <p className={styles.p}>
                No download. No installation. No updates. Open the page and start building habits immediately.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p className={styles.p}>
            While other apps want to be your "habit operating system," we just want you to build habits. Here's how we compare:
          </p>
        ...
        <section>
          ...
          <p className={styles.p}>
            If you've bounced between Habitica's gamification, Streaks' complexity, and Notion templates that require a PhD to set up — you're not alone.
          </p>
          ...
          <p className={styles.p}>
            <strong>
              Simplicity is backed by{' '}
              <Link href="/how-to-build-a-habit" className={styles.link}>
                habit science
              </Link>
              :
            </strong>{' '}
            The less friction between you and your habit, the more likely you are to stick with it long-term.
          </p>
        </section>
        ...
        <section style={{ textAlign: 'center', margin: '3rem 0' }}>
          ...
          <Link href="/free-habit-tracker" className={styles.ctaButton}>
            Try The Simplest Habit Tracker →
          </Link>
      ...
      <footer className={styles.footer}>
        ...
        <p className={styles.p}>
          <Link href="/simple-habit-tracker" className={styles.link}>
            The simplest habit tracker online
          </Link>{' '}
          — because complexity is the enemy of consistency.
        </p>
      </footer>
    </div>
  );
