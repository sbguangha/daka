...
export function EssentialHabitsSection() {
...
export function HabitsWithoutOverwhelm() {
  return (
  ...
  const stories = [
    {
      ...
      story:
        'I used to pull all-nighters before every exam. Started tracking my sleep and study blocks - my GPA went from 2.8 to 3.6 in one semester. The visual streaks kept me going even when I wanted to give up.',
    ...
    },
    {
      ...
      major: 'Psychology',
      story:
        'Between thesis writing and part-time work, I was drowning. Tracking just my morning routine helped me reclaim 2 hours every day. I finally had time for myself again.',
    ...
    },
    {
      ...
      major: 'Business',
      story:
        'Freshman year hit me hard. My printable habit tracker on my dorm wall became my accountability buddy. My roommate even joined in - we both saw our grades improve.',
